                  ...
                  >
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 text-sm text-slate-500 truncate mt-0.5">
                        <User size={12} className="text-slate-400" /> {g.user_count || 0} students
                        {g.start_date && g.end_date && (
                          <>
                            <span> • </span>
                            <span>{new Date(g.start_date).toLocaleDateString('en-CA')}</span>
                            <span> → </span>
                            <span>{new Date(g.end_date).toLocaleDateString('en-CA')}</span>
                          </>
                        )}
                      </div>
                    </div>
